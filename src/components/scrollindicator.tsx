...
const ScrollIndicator = ({
  ...
  return (
    <div className="fixed top-[2%] right-2 md:right-6 -translate-y-0 z-50 py-2 md:py-4 px-1 md:px-2 rounded-md md:rounded-xl flex flex-col items-center gap-[1px] md:gap-[2px] border border-white/20 backdrop-blur-lg">
