...
const LazyImage = ({ image, onLoad,onClick }: { image: ImageItem; onLoad: (img: ImageItem, width: number, height: number) => void,onClick:any }) => {
  ...
  return (
    <div ref={ref} className="group cursor-pointer w-full" onClick={onClick}>
      <motion.div
        ref={ref}
            ...
            <>
              ...
              {error ? (
                ...
                <img
                  ...
                  className={`w-full h-auto object-cover transition-all duration-300 group-hover:opacity-90 group-hover:grayscale-0 grayscale ${
