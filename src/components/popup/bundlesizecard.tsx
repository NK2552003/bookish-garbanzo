...
export default function BundleSizeCard() {
  ...
  return (
    <motion.div 
      className="border border-white/20 p-4 rounded-xl text-white max-w-sm mx-auto absolute bottom-20 md:bottom-auto md:top-20 left-4 md:left-6 w-[90%] md:w-auto pointer-events-none"
