...
const ProjectsCP = () => {
  ...
  const codepenProjectsData = [
    ...
    { id: "NPWEKOP", title: "Project 2" },
    { id: "zxxdmxJ", title: "Project 3" },
    { id: "azOwmKd", title: "Project 4" },
    { id: "WbvOoXN", title: "Project 5" },

    { id: "dPyayZq", title: "Project 6" },
    { id: "EaYdRVB", title: "Project 7" },
    { id: "xbKpwwZ", title: "Project 8" },
    { id: "VYwLJNW", title: "Project 9" },
    { id: "JoPyyxj", title: "Project 10" },
    { id: "gbYyXmM", title: "Project 11" },
    { id: "KwKWPoB", title: "Project 12" },
    { id: "ogvdGVm", title: "Project 13" },
    { id: "VwoLgrj", title: "Project 14" },
    { id: "MWdKBpa", title: "Project 15" },
    { id: "LEPQZeR", title: "Project 16" },
    { id: "ExqvZey", title: "Project 17" },
  ];
  ...
  return (
    <div className="relative z-10 px-8 md:px-20 pt-24 md:pt-30">
      {error && (
